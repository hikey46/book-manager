...
import com.book.manager.presentation.handler.BookManagerAutheticationFailureHandler
...
class SecurityConfig(private val authenticationService: AuthenticationService): WebSecurityConfigurerAdapter() {
  override fun configure(http: HttpSecurity) {
    http.authorizeHttpRequests()
      ...
      .failureHandler(BookManagerAutheticationFailureHandler())
      .and()
      .exceptionHandling()
  ...
  private fun corsConfigurationSource(): CorsConfigurationSource {
    ...
    corsConfiguration.addAllowedOrigin("http://localhost8081")
