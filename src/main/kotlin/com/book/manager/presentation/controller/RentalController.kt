...
import com.book.manager.application.service.security.BookMangerUserDetails
...
class RentalController(
  ...
  fun startRental(@RequestBody request: RentalStartRequest) {
    val user = SecurityContextHolder.getContext().authentication.principal as BookMangerUserDetails
